...
class ApplyView(APIView):
    ...
    def get(self, request, status_id):
        job_status_get = JobPostActivity.objects.filter(status_id)
        serialized_data = JobPostActivitySerializer(job_status_get, many=True).data
    ...
    def post(self, request):
        ...
        if not apply_serialzer.job_status:
            print(apply_serialzer.job_status.add(JobStatus.job_status.submitted))
            apply_serialzer.job_status.add(JobStatus.job_status.submitted)
